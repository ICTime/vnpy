...
# productClassMap[PRODUCT_CFD] = 'CFD'
...
# http://xavierib.github.io/twsapidocs/classIBApi_1_1TickType.html
...
class IbGateway(VtGateway):
    ...
    def subscribe(self, subscribeReq):
        ...
        ct.symbol = subscribeReq.symbol
        ct.exchange = subscribeReq.exchange
        
        ct.vtSymbol = '-'.join([ct.symbol, subscribeReq.expiry])
        ct.vtSymbol = '.'.join([ct.vtSymbol, ct.exchange])
        ct.productClass = subscribeReq.productClass
        print "ibGateway.subscribe: --- ",ct.vtSymbol, contract.__dict__
...
class IbWrapper(EWrapper):
    ...
    def contractDetails(self, reqId, contractDetails):
        """合约查询回报"""
        # print '----------- ibGateway.contractDetails', contractDetails.m_summary.__dict__
        ...
        contract.vtSymbol= vtSymbol
        contract.symbol  = symbol 
        contract.exchange= exchange 
        contract.size    = contractDetails.m_summary.m_multiplier
        contract.name    = contractDetails.m_longName.decode('UTF-8')
        contract.priceTick    = contractDetails.m_minTick        
        contract.strikePrice  = contractDetails.m_summary.m_strike 
        contract.productClass = contractDetails.m_summary.m_secType
        ...
        # 推送
        # print '----------- ibGateway.contractDetails', contractDetails.m_summary.__dict__
        # print '----------- ibGateway.contractDetails', vtSymbol, contract.__dict__
